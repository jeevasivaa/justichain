...
export const AdminLogin: React.FC<AdminLoginProps> = ({ login, setCurrentPage }) => {
            ...
            <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-8 space-y-8 animate-fade-in">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Password is 'password' for default admin"
                            />
                        </div>
                    </div>
                    <div>
                 ...
                 <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <button onClick={() => setCurrentPage(Page.AdminSignUp)} className="font-medium text-blue-600 hover:text-blue-500">
                        Sign up
                    </button>
                </p>
            </div>
